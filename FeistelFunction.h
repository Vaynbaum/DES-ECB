...
public:
   FeistelFunction()
   {
      ...
      // Таблица расширяющей перестановки блока
      ...
      // Таблица завершающей перестановки блока
   ...
   * 
   * Принимает блок block и ключ key
   * 
   * Возращает полученный блок*/
...
private:
   ...
   /*Преобразование блока S-блоками
   * 
   * Принимает блок block
   * 
   * Возвращает блок, после применения S-блоков*/
